% fig 3c (m(0),alpha(0))=(0.5,0)
% initialising parameters

A=100; M=1; T=0.025; Cz=0.65; Cp=0; beta1=1; beta2=1; lambda21=0; lambda12=0; mu=0.001; delta=0.01; NEVOL=1500; f0=0.002; m0=0.5; alpha0=0; 
...
save('Data_files\Fig_3\panel_c\m_fig3c_05.mat','m');
save('Data_files\Fig_3\panel_c\alpha_fig3c_05.mat','alpha');
