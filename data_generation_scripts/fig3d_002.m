% fig 3d (m(0),alpha(0))=(0.02,0)
% initialising parameters

A=100; M=1; T=0.025; Cz=0.9; Cp=0; beta1=1; beta2=1; lambda21=0; lambda12=0; mu=0.001; delta=0.01; NEVOL=1500; f0=0.002; m0=0.02; alpha0=0; 
...
save('Data_files\Fig_3\panel_d\m_fig3d_002.mat','m');
save('Data_files\Fig_3\panel_d\alpha_fig3d_002.mat','alpha');
