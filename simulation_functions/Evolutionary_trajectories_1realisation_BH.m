function [genotypeDATA_m,genotypeDATA_alpha,m,alpha]=Evolutionary_trajectories_1realisation_BH(m0,alpha0,A,M,T,Cz,Cp,beta1,beta2,lambda21,lambda12,mu,NEVOL,f0,delta,alphamax,return_genotypes)
